...
class OrganizerContestDetailsPageBloc
  ...
  OrganizerContestDetailsPageBloc(
    ...
    on<OrganizerContestDetailsPageCleanAndGetExtendedContest>(_cleanAndGetExtendedContest);
  }
  ...
  FutureOr<void> _cleanAndGetExtendedContest(OrganizerContestDetailsPageCleanAndGetExtendedContest event, Emitter<OrganizerContestDetailsPageState> emit,) async{
    emit(OrganizerContestDetailsPageState(status: BlocStatus.initial));
    add(OrganizerContestDetailsPageGetExtendedContest(contestId: event.contestId));
  }
}
