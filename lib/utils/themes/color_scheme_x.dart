...
extension ColorSchemeX on ColorScheme {
  ...
  Color get silver =>
      brightness == Brightness.light ? const Color(0xffc0c0c0) : const Color(0xffc0c0c0);

  Color get grey =>
      brightness == Brightness.light ? const Color(0xff808080) : const Color(0xff808080);

  Color get black =>
      brightness == Brightness.light ? const Color(0xff000000) : const Color(0xff000000);

  Color get red =>
      brightness == Brightness.light ? const Color(0xffff0000) : const Color(0xffff0000);

  Color get maroon =>
      brightness == Brightness.light ? const Color(0xff800000) : const Color(0xff800000);

  Color get yellow =>
      brightness == Brightness.light ? const Color(0xffffff00) : const Color(0xffffff00);

  Color get olive =>
      brightness == Brightness.light ? const Color(0xff808000) : const Color(0xff808000);
  ...
  Color get teal =>
      brightness == Brightness.light ? const Color(0xff008080) : const Color(0xff008080);

  Color get blue =>
      brightness == Brightness.light ? const Color(0xff0000ff) : const Color(0xff0000ff);

  Color get navy =>
      brightness == Brightness.light ? const Color(0xff000080) : const Color(0xff000080);

  Color get magenta =>
      brightness == Brightness.light ? const Color(0xffff00ff) : const Color(0xffff00ff);

  Color get purple =>
      brightness == Brightness.light ? const Color(0xff800080) : const Color(0xff800080);

  Color get lightBlue =>
      brightness == Brightness.light ? const Color(0xffadd8e6) : const Color(0xffadd8e6);

  Color get pink =>
      brightness == Brightness.light ? const Color(0xffffc0cb) : const Color(0xffffc0cb);

  Color get orange =>
      brightness == Brightness.light ? const Color(0xffffa500) : const Color(0xffffa500);

  Color get aquamarine =>
      brightness == Brightness.light ? const Color(0xff7fffd4) : const Color(0xff7fffd4);
