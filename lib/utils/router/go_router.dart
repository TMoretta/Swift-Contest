...
import 'package:swift_contest/utils/router/my_routes.dart';
...
//           matchedLocation != '/sign-up-verify' &&
//           matchedLocation != '/sign-in-verify') {
//         return '/sign-in';
//       }
//       // Se l'utente è autenticato e prova ad andare in pagine per l'autenticazione lo reindirizza alla home
//       if (authState.authStatus.isAuthenticated &&
...
//           ),
//           GoRoute(
//             path: 'simple-juror-voting/:simpleJurorId/:votingSessionId',
//             pageBuilder: (context, state) {
//               final String simpleJurorId = state.pathParameters['simpleJurorId'] as String;
//               final String votingSessionId = state.pathParameters['votingSessionId'] as String;
//               return MaterialPage(
//                 child: BlocProvider(
//                   create: (context) => SimpleJurorVotingProcedurePageBloc(
//                     genericRepository: context.read(),
//                     jurorRepository: context.read(),
//                   ),
//                   child: SimpleJurorVotingProcedurePage(simpleJurorId: simpleJurorId, votingSessionId: votingSessionId),
//                 ),
//               );
//             },
//           )
...
//             pageBuilder: (context, state) {
//               final String contestId = state.pathParameters['contestId'] as String;
//               return MaterialPage(
//                 child: BlocProvider(
//                   create: (context) => OrganizerContestEditPageBloc(
//                     genericRepository: context.read(),
...
//       ),
//       GoRoute(
//         path: '/participant_home/:contestId',
//         pageBuilder: (context, state) {
//           return MaterialPage(
//             child: BlocProvider(
//               create: (context) => ParticipantHomePageBloc(
