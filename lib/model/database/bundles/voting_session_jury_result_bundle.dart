...
//   });
//
//   factory VotingSessionJuryResultBundle.fromRawJson(Map<String, dynamic> json) {
...
//         .toList();
//     // La RPC per una singola giuria restituisce una lista con un solo elemento.
//     final votingSessionJuryBundle =
//     VotingSessionJuryBundle.fromJson(json['voting_session_jury_bundle']);
...
//     final allVotingSessionJurations = votingSessionJuryBundle.votingSessionJurations;
//     final allVotingFormFields = votingSessionJuryBundle.votingFormBundle.votingFormFields;
//
//     // 3. Mappatura dei voti.
//     final Map<VotingSessionJuration, Map<VotingSessionParticipation, List<JurorVoteBundle>?>>
//     participantsVotingsPerJurorMap = {};
//     final List<VotingSessionJuration> jurorsWithoutSubmission = [];
//
...
//
//         if (jurorVoting == null) {
//           // Il giurato ha sottomesso ma non per questo partecipante.
