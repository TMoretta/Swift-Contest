...
class _OrganizerContestCreationPageState extends State<OrganizerContestCreationPage> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => getIt<OrganizerContestCreationPageBloc>(),
...
// import 'package:image_picker/image_picker.dart';
// import 'package:intl/intl.dart';
// import 'package:swift_contest/model/models/google_place.dart';
// import 'package:swift_contest/model/models/place.dart';
...
// import 'package:swift_contest/view/widgets/time_picker_field.dart';
// import 'package:swift_contest/viewmodel/blocs/app_auth_bloc/app_auth_bloc.dart';
// import 'package:swift_contest/viewmodel/blocs/contest_creation_bloc/contest_creation_bloc.dart';
//
// class ContestCreationPage extends StatefulWidget {
//   const ContestCreationPage({super.key});
//
//   @override
//   State<ContestCreationPage> createState() => _ContestCreationPageState();
// }
//
...
//       },
//       child: BlocProvider(
//         create: (context) => getIt<ContestCreationBloc>(),
//         child: BlocBuilder<ContestCreationBloc, ContestCreationState>(
//           builder: (context, state) {
//             return Scaffold(
//               appBar: CustomAppBar(title: 'Contest Creation'),
//               body: Stepper(
...
//                       final dateTime =
//                           DateTime(date!.year, date!.month, date!.day, time!.hour, time!.minute);
//                       context.read<ContestCreationBloc>().add(
//                             ContestCreationCreateContest(
//                               name: name,
//                               description: description,
//                               organizerId: user.id,
//                               place:
...
//                           onPressed: details.onStepContinue,
//                           child: isLastStep
//                               ? BlocConsumer<ContestCreationBloc, ContestCreationState>(
//                                   listener: (context, state) {
//                                     if (state is ContestCreationSuccess) {
//                                       showSnackBar(
//                                           context: context, text: 'Contest created successfully');
//                                       context.go('/home');
//                                     }
//                                   },
//                                   builder: (context, state) {
//                                     if (state is ContestCreationLoading) {
//                                       return Loader();
//                                     }
//                                     return Text('Create');
//                                   },
