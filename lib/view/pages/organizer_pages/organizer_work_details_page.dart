...
class _OrganizerWorkDetailsPageState extends State<OrganizerWorkDetailsPage> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<OrganizerWorkDetailsPageBloc>(
      create: (context) => OrganizerWorkDetailsPageBloc(organizerRepository: context.read())
        ..add(OrganizerWorkDetailsPageInit(participationId: participationId)),
      child: BlocConsumer<OrganizerWorkDetailsPageBloc, OrganizerWorkDetailsPageState>(
                  ...
                  builder: (context) {
                    switch (state.status) {
                      ...
                      case BlocStatus.failure:
                        if (state.sourceEvent is OrganizerWorkDetailsPageInit) {
                          return RefreshIndicator.adaptive(
                            onRefresh: () async => context.read<OrganizerWorkDetailsPageBloc>().add(
                      ...
                      case BlocStatus.success:
                        ...
                        return RefreshIndicator.adaptive(
                          onRefresh: () async => context.read<OrganizerWorkDetailsPageBloc>().add(
                              OrganizerWorkDetailsPageRefresh(participationId: participationId)),
                          child: ListView(
                            children: [
                              SizedBox(height: 16),
                              //* Title
