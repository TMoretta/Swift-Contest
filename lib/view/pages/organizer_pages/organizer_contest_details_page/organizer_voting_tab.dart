              ...
              builder: (context) {
                switch (state.status) {
                  ...
                  case BlocStatus.success:
                    final endedVotingSessions = state.contestDetailsBundle!.votingSessions.where((e)=> e.sessionStatus.isEnded).toList(growable: false);
                    return Column(
          ...
          floatingActionButton: Builder(
            builder: (context) {
              switch (state.status) {
                ...
                successCase:
                case BlocStatus.success:
                  final liveVotingSession = state.contestDetailsBundle!.votingSessions.where((e)=>!e.sessionStatus.isEnded && !e.sessionStatus.isCancelled).singleOrNull;
                  if (liveVotingSession == null) {
                    return FloatingActionButton.extended(
                      onPressed: () async {
                        if (state.contestDetailsBundle!.juriesBundles.map((e)=> e.jurationsBundles).toList(growable: false).isEmpty) {
                          showSnackBar(
                            context: context,
