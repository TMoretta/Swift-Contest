                  ...
                  builder: (context, state) {
                    switch (state.status) {
                      ...
                      case BlocStatus.loading:
                        // if (state.sourceEvent is JurorVotingProcedurePageSubmitVotes) {
                          ...
                          builder: (context, constraints) {
                            return RefreshIndicator.adaptive(
                              onRefresh: () async => context
                                  ...
                                  .add(JurorVotingProcedurePageResubscribeToVotingSessionProcedure(
                                      votingSessionId: votingSessionId)),
                                    ...
                                    switch (sessionStatus) {
                                      ...
                                      case VotingSessionStatus.work:
                                        final currentStepDeadline =
                                            votingSession.currentStepDeadline!;
                                        ...
                                        final isExcludedFromParticipant =
                                            (votingSessionProcedureBundle.votingSessionExclusions
                                                        .where((e) =>
                                      ...
                                      case VotingSessionStatus.review:
                                        final currentStepDeadline =
                                            votingSession.currentStepDeadline!;
                                        final participantsExcludedFrom =
                                            votingSessionProcedureBundle.votingSessionExclusions
                                                .where((e) =>
                                                    e.votingSessionJurationId ==
                                                    thisVotingSessionJuration.id)
                  ...
                  builder: (context, state) {
                    if (state.status.isLoading) {
                      return Positioned.fill(
                        child: Container(
                          color: Colors.black54, // oscuramento
                          child: Center(child: Loader()), // loader al centro
                        ),
                      );
                    }
                    return SizedBox.shrink();
