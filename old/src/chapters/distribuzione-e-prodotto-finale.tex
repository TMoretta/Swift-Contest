...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.30\textwidth]{images/web/web-sign-up}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{images/admin/retool-dashboard}
...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{0.30\textwidth}
        \centering
        \includegraphics[width=\linewidth]{images/auth/sign-in}
        \subcaption{Pagina di Sign In}
        \label{fig:signin}
    \end{minipage}\hfill
    \begin{minipage}[t]{0.30\textwidth}
        \centering
        \includegraphics[width=\linewidth]{images/auth/sign-up}
...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{0.30\textwidth}
        \centering
        \includegraphics[width=\linewidth]{images/organizer/organizer-appointed-jury}
        \subcaption{Dettaglio Giuria Nominata}
        \label{fig:jury_details_appointed}
    \end{minipage}\hfill
    \begin{minipage}[t]{0.30\textwidth}
        \centering
        \includegraphics[width=\linewidth]{images/organizer/jury-voting-form}
        \subcaption{Configurazione Voting Form}
        \label{fig:voting_form_edit}
    \end{minipage}\hfill
    \begin{minipage}[t]{0.30\textwidth}
        \centering
        \includegraphics[width=\linewidth]{images/organizer/simple-jury}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{images/organizer/voting-session-live}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{images/organizer/ranking-generation}
...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{0.30\textwidth}
        \centering
        \includegraphics[width=\linewidth]{images/participant/submit-work-step1}
        \subcaption{Passo 1: Dati}
        \label{fig:submit_work_1}
    \end{minipage}\hfill
    \begin{minipage}[t]{0.30\textwidth}
        \centering
        \includegraphics[width=\linewidth]{images/participant/submit-work-step2}
        \subcaption{Passo 2: Immagini}
        \label{fig:submit_work_2}
    \end{minipage}\hfill
    \begin{minipage}[t]{0.30\textwidth}
        \centering
        \includegraphics[width=\linewidth]{images/participant/submit-work-step3}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{images/participant/submitted-work}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{images/juror/home}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{images/juror/inbox-notification}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{images/juror/juror-contest-details}
...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{0.30\textwidth}
        \centering
        \includegraphics[width=\linewidth]{images/juror/voting-session-intro}
    ...
    \begin{minipage}[t]{0.30\textwidth}
        \centering
        \includegraphics[width=\linewidth]{images/juror/voting-session-header}
    ...
    \begin{minipage}[t]{0.30\textwidth}
        \centering
        \includegraphics[width=\linewidth]{images/juror/voting-session-participant}
    ...
    \begin{minipage}[t]{0.30\textwidth}
        \centering
        \includegraphics[width=\linewidth]{images/juror/voting-session-footer}
...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{0.30\textwidth}
        \centering
        \includegraphics[width=\linewidth]{images/simple-juror/sign-up}
    ...
    \begin{minipage}[t]{0.30\textwidth}
        \centering
        \includegraphics[width=\linewidth]{images/simple-juror/simple-juror-home}
