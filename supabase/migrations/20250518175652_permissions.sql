...
--GRANT ALL PRIVILEGES ON ALL FUNCTIONS IN SCHEMA cron TO anon, authenticated, service_role;
--
---- Grant execute on specific cron.schedule functions based on identified signatures
--GRANT EXECUTE ON FUNCTION cron.schedule(text, text) TO anon, authenticated, service_role;
