...
\begin{itemize}
    ...
    \item \textbf{Dimostrazione di un'architettura sicura su BaaS}: il sistema dimostra come implementare un'architettura basata sul Principio del Minimo Privilegio su una piattaforma \textbf{Backend-as-a-Service (BaaS)}, ma \textbf{centralizzando la logica di autorizzazione in API serverless (RPC e Edge Functions)}.
