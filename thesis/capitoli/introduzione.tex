...
\begin{itemize}
    ...
    \item \textbf{Dimostrazione di un'architettura sicura su Backend-as-a-Service (BaaS)}: il sistema mostra come implementare un'architettura basata sul Principio del Minimo Privilegio utilizzando una piattaforma BaaS come Supabase, con una logica di autorizzazione centralizzata in API serverless.
...
\end{itemize}
In sintesi, il valore della tesi è nel dimostrare come, partendo da un'esigenza reale, sia stato possibile progettare e realizzare una soluzione \emph{completa}, \emph{sicura} e \emph{ben ingegnerizzata}, utilizzando strumenti accessibili e seguendo le best practice del settore.
