...
L'analisi dello stato dell'arte, come verrà dettagliato nel \textbf{Capitolo 3}, ha inoltre rivelato un \textbf{significativo vuoto di mercato}: non esistono soluzioni verticali e accessibili che coprano in modo integrato l'intero ciclo di vita di un \emph{contest}.
...
\begin{itemize}
    ...
    Oltre ai \textbf{giurati nominati} (utenti registrati e invitati), il sistema deve permettere la partecipazione di \textbf{giurati semplici} tramite un token di accesso sicuro, abbassando così la barriera d'ingresso per i giurati occasionali.
    ...
    \item \textbf{Gestione e moderazione del sistema:} realizzare una dashboard amministrativa per la gestione degli utenti e la moderazione dei contenuti.
\end{itemize}
...
\begin{itemize}
    \item \textbf{Capitolo 2 – Tecnologie e strumenti utilizzati}: descrive lo stack tecnologico adottato, giustificando le scelte chiave in relazione agli obiettivi del progetto e ai vincoli di sviluppo.
    \item \textbf{Capitolo 3 – Contesto e analisi del sistema}: definisce in dettaglio il problema, analizza lo stato dell’arte e presenta i requisiti del sistema.
    ...
    \item \textbf{Capitolo 6 – Conclusioni}: riflette sui risultati ottenuti e sul percorso di crescita personale.
\end{itemize}