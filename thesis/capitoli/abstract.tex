\begin{titlepage}
    \begin{abstract}
        ...
        La progettazione del sistema si fonda su un’architettura sicura basata sul \textbf{Principio del Minimo Privilegio (PoLP)}, dove la Row Level Security (RLS) e un'API controllata lavorano in sinergia per mediare ogni accesso ai dati.
        Sul frontend, il pattern \textbf{MVVM con BLoC} garantisce la separazione delle responsabilità, mentre sul backend, il \textbf{meccanismo di snapshot} assicura l’integrità del voto.
        ...
        La fase finale del progetto ha visto la distribuzione delle sue componenti: le migrazioni IaC e le funzioni serverless sono state rilasciate sull'infrastruttura Supabase; il client web è stato distribuito su Vercel tramite pipeline di CI/CD; e l'artefatto Android su GitHub, culminando in un \textbf{prototipo completo e funzionante}.
