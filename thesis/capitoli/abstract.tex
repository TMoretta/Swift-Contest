\begin{titlepage}
    \begin{abstract}
        ...
        La fase finale del progetto ha visto la distribuzione delle sue componenti: le \textbf{migrazioni IaC e le funzioni serverless} sono state rilasciate sull'infrastruttura \textbf{Supabase}, il client web è stato distribuito su \textbf{Vercel} tramite pipeline di CI/CD e l'artefatto Android su \textbf{GitHub}.
        Il risultato è un \textbf{prototipo completo e funzionante}.
