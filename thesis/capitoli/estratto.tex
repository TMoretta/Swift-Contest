\begin{titlepage}
    \begin{abstract}
        ...
        Il sistema prevede due tipi di giurie: ``\textbf{Giurie Nominate}'', per giurati invitati a iscriversi formalmente al contest, e ``\textbf{Giurie Semplici}'', che permettono l'accesso alla votazione tramite un token condiviso, supportando anche utenti non registrati attraverso un meccanismo di \textbf{autenticazione anonima}.
        L'applicazione è sviluppata in \textbf{Flutter} per garantire un'esperienza \textbf{cross-platform} coerente su Web e Android, con un backend robusto basato su \textbf{Supabase (PostgreSQL)}.
