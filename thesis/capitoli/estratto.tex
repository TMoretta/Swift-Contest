\begin{titlepage}
    \begin{abstract}
        ...
        La fase finale del progetto ha visto la distribuzione delle sue componenti su piattaforme dedicate: le migrazioni IaC e le funzioni serverless sull'infrastruttura \textbf{Supabase}, il client web su \textbf{Vercel} tramite pipeline di CI/CD e l'artefatto Android su \textbf{GitHub}. \textbf{Questo processo ha portato alla realizzazione di un prototipo completo e funzionante}.
