...
\subsection{Piattaforme di distribuzione e Servizi Cloud}\label{subsec:piattaforme-di-deployment-e-servizi-cloud}
...
\end{wrapfigure}
\textbf{Vercel} è la piattaforma serverless utilizzata per la distribuzione e l'hosting della versione \textbf{Web} dell'applicazione Flutter.
...
\end{wrapfigure}
\textbf{Node Package Manager (npm)} è stato uno strumento indispensabile per l'installazione e la gestione di dipendenze di sviluppo, prima tra tutte la \textbf{CLI di Supabase}, utilizzata per gestire le migrazioni del database e la distribuzione delle Edge Functions.
\vspace{1em}
