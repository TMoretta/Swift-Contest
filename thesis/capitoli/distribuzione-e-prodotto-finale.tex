...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{0.30\textwidth}
        ...
        \subcaption{Impostazioni generali}
        \label{fig:settings}
    \end{minipage}
    \quad
    \begin{minipage}[t]{0.30\textwidth}
        ...
        \subcaption{Impostazioni account}
...
\begin{figure}[H]
    ...
    \caption{Home page organizzatore.}
...
Terminata la votazione, la pagina dei risultati permette all'organizzatore di analizzare i dati.
