...
\begin{figure}[H]
    ...
    \begin{minipage}{0.32\textwidth}
        \centering
        \includegraphics[width=\linewidth]{images/organizer-appointed-jury}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{images/participant-submitted-work}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{images/juror-inbox-notification}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{images/juror-contest-details}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.32\textwidth}
        \centering
        \includegraphics[width=\linewidth]{images/simple-juror-home}
